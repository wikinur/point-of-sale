        ...
        var columns = [
            ...
            {render: function(index, row, data, meta){
                return `
                    ...
                    <a class="btn btn-danger btn-sm" onclick="controller.deleteData(event, ${data.id_member})" title="delete"><i class="fa fa-trash fa-sm text-white"></i></a>
                `;
            }, orderable:false},
        ];
        ...
        var controller = new Vue({
            ...
            methods:{
                ...
                editData(event, row){
                    ...
                    this.dataMember = this.datas[row];
                    this.editStatus= true;
                    $("#modalForm").modal();
                    $('.modal-title').text('Ubah Member');
                },
                deleteData(event, id_member){
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(this.actionUrl+ '/' + id_member, {_method: 'DELETE'}).then(response =>{
                ...
                submitForm(event, id_member){
                    event.preventDefault();
                    const _this = this;
                    var actionUrl = ! this.editStatus ? this.actionUrl : this.actionUrl+'/'+id_member;
